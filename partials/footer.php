...
<div class="footerbg">
    ...
    <footer class="footer-bs">
        <div class="container">
        <div class="row">
        	<div class="col-md-5 footer-brand animated fadeInCenter">
            	<img src="images/logo_mro.png">
                <section style="text-align:center; margin:10px auto;"><p> <a href="#">Designed by IT 2022</a></p></section>
            </div>
         </div>
