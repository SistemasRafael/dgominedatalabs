                                           ...
                                           $muestras_det = $mysqli->query("SELECT 
                                                          ...
                                                          FROM  arg_ordenes_soluciones om 
                                                              ...
                                                              WHERE 
                                                               ...
                                                               ORDER BY
                                                                    om.folio_interno") or die(mysqli_error($mysqli));
                                    }
                                    else{
                                         if ($orden_encabezado['tipo_orden'] == 5){
                                               $muestras_det = $mysqli->query("SELECT 
                                                                     om.trn_id_rel
                                                                    ,(CASE WHEN om.tipo_id = 1 THEN mr.nombre ELSE om.folio_interno END) AS folio_interno
                                                                    ,om.muestra_geologia
                                                              FROM  
                                                                    ordenes_sobrelimites om
                                                                    LEFT JOIN arg_controles_materiales mr
                                                                        ON mr.material_id = om.material_id
                                                                        AND om.tipo_id = 1
                                                              WHERE 
