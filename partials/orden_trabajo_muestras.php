...
?>
        ...
        <div class="container">
            <div class="container">
                ...
                <div class="col-md-4 col-lg-4">
                        <select name="metodo_id_sel" id="metodo_id_sel" value="<?php echo $metodo_id;?>" onchange="redireccion(<?php echo $trn_id.", ".$metodo_id.", ".$unidad_id?>)"  class="form-control"> 
                ...
                <div class="col-4 col-md-4 col-lg-4">
                    <button type="button" class="btn btn-info" name="print_muestras" id="print_muestras" onclick="print_muestras(<?php echo $trn_id.", ".$metodo_id.", 1";?>)">  <span class="fa fa-file-pdf-o fa-2x">  Imprimir</span>    </button>
