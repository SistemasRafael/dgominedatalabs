...
<div class="modal fade" id="ModalMaterialRef" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <br />
        ...
        <h5 style="width:470px; color:#4999e9" >ELEMENTO Ag</h5>
        <br />

       <label for="ley_material_ag" class="col-form-label">Ley:</label>
        <input name="ley_material_ag" id="ley_material_ag" size=40 style="width:470px; color:#996633" value="" enabled />
        <label for="desv_esta_material_ag" class="col-form-label">Desviación Estándar:</label>
        <input name="desv_esta_material_ag" id="desv_esta_material_ag" size=40 style="width:470px; color:#996633" value="" enabled />

        <label for="cant_desv_sta_ag" class="col-form-label">Cantidad Desviación:</label>
        <input name="cant_desv_sta_ag" id="cant_desv_sta_ag" size=40 style="width:470px; color:#996633" value="" enabled />
        <br />
            ...
            <br />
                    <? $datos_materiales = $mysqli->query(
                                                            "SELECT 
                                                                ...
                                                                ,`valor_ley_ag`, `desv_est_ag`
                                                                ,`cant_desv_ag`, `maximo_ag`, `minimo_ag`
                     ...
                     <div class="container" class="col-md-2 col-lg-12">
                        ...
                        <br/><br/>
                            ...
                            $html_det = "<div class='container'>
                                    ...
                                    <thead>
                                        <tr class='table-info' justify-content: center;>  
                                            ...
                                            <th scope='col1'>Ley Ag</th>
                                            <th scope='col1'>DesvEst Ag</th>                                        
                                            <th scope='col1'>CantDesv Ag</th>
                                            <th scope='col1'>Máx Ag</th>
                                            <th scope='col1'>Mín Ag</th>                  
                            ...
                            while ($fila = $datos_materiales->fetch_assoc()) {
                              ...
                              $html_det .= "<td>" . $fila['valor_ley_ag'] . "</td>";
                              $html_det .= "<td>" . $fila['desv_est_ag'] . "</td>";
                              $html_det .= "<td>" . $fila['cant_desv_ag'] . "</td>";
...
if (isset($_POST['subir_poliza'])) {
  ...
  //Segundo elemento Ag
  $ley_ag  = $_POST['ley_material_ag'];
  $desv_esta_ag = $_POST['desv_esta_material_ag'];
  $cant_desv_esta_ag  = $_POST['cant_desv_sta_ag'];
  
  if($ley_ag <> 0 and $ley_ag <> ''){
    $can_maximo_ag = $ley_ag+($desv_esta_ag*$cant_desv_esta_ag);//$_POST['mref_maximo'];
    $can_minimo_ag = $ley_ag-($desv_esta_ag*$cant_desv_esta_ag); //$_POST['mref_minimo'];
  }else{
    $ley_ag = 'null';
    $can_maximo_ag = 'null';
    $can_minimo_ag = 'null';
    $desv_esta_ag = 'null';
    $cant_desv_esta_ag = 'null';
  }
  
  $archivo = $_FILES['pol_vehi']['name'];  
  //echo 'llego'.$unidad_id.$archivo;
  ...
  if($archivo == ''){
     ...
     // die();
      ...
      if (isset($u_id)) {
        ...
        $query = "INSERT INTO arg_controles_materiales (unidad_id, material_id, nombre, control_id, valor_ley, desv_esta, cantidad_desviacion, maximo, minimo, metodo_id, valor_ley_ag, desv_est_ag, cant_desv_ag, maximo_ag, minimo_ag, u_id, ricos_pobres, file_path) " .
                 "VALUES ($unidad_id, $material_id, '$nombre', 2, $ley, $desv_esta, $cant_desv_esta, $can_maximo, $can_minimo, $met_asign, $ley_ag, $desv_esta_ag, $cant_desv_esta_ag, $can_maximo_ag, $can_minimo_ag, $u_id, $ricospobres, '$desti')";
        $mysqli->query($query);
       // echo $query;
        //die();
