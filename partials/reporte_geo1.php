...
$date =  date("Y-m-d");//'2023-01-01';
$fecha_inicial = date("Y-m-d", strtotime($date));//date("d-m-Y", strtotime($date));
$fecha_final =  date("Y-m-d");// date("d-m-Y");
?>
     ...
     //   $mysqli->set_charset("utf8");
       ...
       $datos_geo = $mysqli->query("SELECT om.folio
        ...
        while ($fila = $datos_geo->fetch_assoc()) {
            ...
            $html_det .= "<td>" . $fila['fecha_res_Au'] . "</td>";
            $html_det .= "<td>" . $fila['hora_res_Au'] . "</td>";
            $html_det .= "<td>" . $fila['fecha_res_Ag'] . "</td>";
            $html_det .= "<td>" . $fila['hora_res_Ag'] . "</td>";
...
*/
    function exportar_listado(unidad_id_e) {
      ...
      /*  alert(fecha_inicial_ex);
        ...
        var exportar = '<?php echo "\ exportar_reporte_geo1.php?unidad_id=" ?>' + unidad_id_ex + '&fecha_inicial=' +fecha_inicial_ex + '&fecha_final=' + fecha_final_ex;
