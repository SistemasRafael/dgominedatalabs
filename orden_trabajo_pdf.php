...
if ($orden_encabezado['tipo'] == 2){
    $pdf_header .= '<img margin="10%" width="' . (floor($iwidth * $img_factor)) . '" height="' . (floor(($iwidth * $ifactor) * $img_factor)) . '" src="http://192.168.10.112/dgominedatalabs/images/encabezado_sol.jpg">';    
}
elseif($orden_encabezado['tipo'] == 7){
  $pdf_header .= '<img margin="10%" width="' . (floor($iwidth * $img_factor)) . '" height="' . (floor(($iwidth * $ifactor) * $img_factor)) . '" src="http://192.168.10.112/dgominedatalabs/images/encabezado_prep.jpg">';
}
else{
    $pdf_header .= '<img margin="10%" width="' . (floor($iwidth * $img_factor)) . '" height="' . (floor(($iwidth * $ifactor) * $img_factor)) . '" src="http://192.168.10.112/dgominedatalabs/images/encabezado_visita.jpg">';
}
