...
$orden = $_POST['orden'];
$id = $_POST['id'];
$unidadmina = $_POST['unidad_id'];
$html = '';
$orden_existente = $mysqli->query("SELECT COUNT(*) AS existe FROM arg_ordenes_muestrasSoluciones WHERE area_id = 1 AND unidad_id = $unidadmina AND orden = ".$orden);
