...
mysqli_multi_query($mysqli, "CALL arg_rpt_pesajesMuestrasMetalurgia(" . $tipo_mues . ", " . $orden . ", " . $metodo_sel.", '".$fecha_ini."', '".$fecha_fin."')") or die(mysqli_error($mysqli));
...
$objSheet->setCellValue('F2', 'Fecha Secado');
$objSheet->setCellValue('G2', 'Secado');
$objSheet->setCellValue('H2', 'Peso Que');
$objSheet->setCellValue('I2', 'Peso Malla Que');
$objSheet->setCellValue('J2', 'Porc Que');
$objSheet->setCellValue('K2', 'Peso Pul');
$objSheet->setCellValue('L2', 'Peso Malla Pul');
$objSheet->setCellValue('M2', 'Porc Pul');
$objSheet->setCellValue('N2', 'Peso Metodo');
//$objSheet->setCellValue('N2', 'Incuarte');
$objSheet->setCellValue('O2', 'Peso Payon');
$objSheet->setCellValue('P2', 'Peso Dore');

$objSheet->setCellValue('Q2', 'Peso Oro');
$objSheet->setCellValue('R2', 'Au_PPM');
