   ...
   mysqli_multi_query ($mysqli, "CALL arg_prc_ordenMetodoPesoHum(".$trnid_m.", ".$trnidrel_m.", ".$metodo_sel.", ".$fase_sel.", ".$etapa_sel.", ".$cantidad.", ".$u_id.",".$final.")") OR DIE (mysqli_error($mysqli));  
    ...
    if ($fase_sel == 11 && $etapa_sel == 6 && $metodo_sel == 2){
       ...
       if ($resultado->num_rows > 0) {
            ...
            if ($fase_sel == 11 && $etapa_sel == 6){
                 $html .=  "<table class='table text-black' id='tabla_pesaje_met'>
                                <thead class='thead-info' align='center'>
                                   <tr class='table-info'>
                                        <th colspan='6'>".$metodo_codigo." Fase: ".$metodo_fase." - ".$metodo_etapa."</th>
                                    </tr>
                                    <tr class='table-warning' align='center'>
                                        <th colspan='6'>ORDEN DE TRABAJO: ".$orden_trabajo."</th>
                                    </tr>"; 
                        ...
                        if ($peso < 20 || $peso > 50){
                            ...
                            $html.="<tr>";
                                 ...
                                 $html.="<td>".$cont."</td> 
                                   ...
                                   <td>".$muestra_met."</td>
                                   <td>".$control."</td>
                                   <td> <input type='number' id='peso_pay".$cont."' value='".$peso."' class='form-control' /> </td>
                                   <td> <button type='button'class='btn btn-primary' id='boton_save_pay' onclick='met_payon_guardarEditCarb(".$trnid_batch_met.",".$trnid_rel_met.",".$metodo_sel.",".$fase_sel.",".$etapa_sel.",".$cont.")' >
    ...
    }//Termina de enlistar todos las muestras en peso payón
    elseif($fase_sel == 10 && $etapa_sel == 20 && $metodo_sel == 2){ //Inicia peso de doré
       ...
       if ($resultado->num_rows > 0) {
            ...
            $html .=  "<table class='table text-black' id='tabla_pesaje_met'>
                                <thead class='thead-info' align='center'>
                                   <tr class='table-info'>
                                        <th colspan='5'>".$metodo_codigo." Fase: ".$metodo_fase." - ".$metodo_etapa."</th>
                                    </tr>
                                    <tr class='table-warning' align='center'>
    ...
    }//Fin de etapa peso de dore
    elseif($fase_sel == 10 && $etapa_sel == 21 && $metodo_sel == 2){ //Inicia peso de oro
       ...
       if ($resultado->num_rows > 0) {
        ...
        $html.="<div class='container-fluid'><td></td>
                            <td style='align:center;'> 
                                <button type='button'class='btn btn-warning' id='boton_save_payconfirm' onclick='met_payon_finalizarCarb(".$trnid_batch_met.",".$metodo_sel.",".$fase_sel.",".$etapa_sel.")' >
